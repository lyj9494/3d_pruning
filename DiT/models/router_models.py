...
class DiT(nn.Module):
    ...
    def forward(self, x, t, y, thres=None, activate_router=False, fix_reuse_feature=False, label_for_dropout=None, ori=False, model_train=False):
        """
        Forward pass of DiT.
        ...
        if activate_router and not ori : # TODO: oringinal
        ...
        for i, block in enumerate(self.blocks):
            ...
            if not fix_reuse_feature and not ori:
                if not model_train:
                    ...
                    self.reuse_feature[i] = tuple(feature.clone().detach() for feature in reuse_feature)
