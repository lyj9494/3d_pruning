...
def main(args):
    ...
    for step in range(1000):
        ...
        for i in indices:
            ...
            if i >= args.num_sampling_steps*4/5:
                loss_scale = 0.1 #* loss_scale
            elif i >= args.num_sampling_steps*1/2:
                loss_scale = 1 #* loss_scale
            else:
                loss_scale = 10 #* loss_scale
            # elif i >= 12:
            ...
            if train_steps % args.log_every == 0: 
                scores = [model.routers[idx]() for idx in range(0, args.num_sampling_steps)]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--results-dir", type=str, default="results_new_mask")
