...
if __name__ == "__main__":
    ...
    parser.add_argument("--sample-dir", type=str, default="new_true_256_2_512_100_samples")
    parser.add_argument("--per-proc-batch-size", type=int, default=8) #1 32 8 4
    parser.add_argument("--num-fid-samples", type=int, default=50_000)
    parser.add_argument("--image-size", type=int, choices=[256, 512], default=512) # 512
...
'''
torchrun --nnodes=1 --nproc_per_node=2 --master_port 12345 sample_ddp.py --model DiT-XL/2 --num-sampling-steps 20 --ddim-sample --accelerate-method dynamiclayer --path /workspace/luoyajing/DiT/test_results/000-DiT-XL-2/checkpoints/0033000_ste0p5.pt --thres 0.5 --sample-dir results/thres_0.5
